...
`Search exo.mast <https://exo.mast.stsci.edu/exomast_planet.html?planet=Kepler37b>`_

`Search SIMBAD <http://simbad.cds.unistra.fr/simbad/sim-basic?Ident=Kepler-37&submit=SIMBAD+search>`_
