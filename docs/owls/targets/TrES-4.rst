...
`Search exo.mast <https://exo.mast.stsci.edu/exomast_planet.html?planet=TrES4b>`_

`Search SIMBAD <http://simbad.cds.unistra.fr/simbad/sim-basic?Ident=TrES-4&submit=SIMBAD+search>`_
